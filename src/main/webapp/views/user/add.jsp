		...
		<form action="users?action=insert" method="post">
			<c:if test="${errors != null}">
				<table>
					...
					<tr>
						<td><div
								style="white-space: pre; text-align: left; color: red;">
			...
			<table border="1">
				...
				<tr>
					...
					<td><input type="text" name="firstName" maxlength="50"
						size="50" value="<c:out value='${user.firstName}' />" /></td>
				</tr>
				<tr>
					<th>Last Name:</th>
					<td><input type="text" name="lastName" maxlength="50"
						size="50" value="<c:out value='${user.lastName}' />" /></td>
				</tr>
				<tr>
					<th>Email:</th>
				...
				<tr>
					...
					<td><input type="text" name="password" maxlength="20"
						size="15" value="<c:out value='${user.password}' />" /></td>
				</tr>
				<tr>
					<th>Birthday:</th>
					...
					</select> <select name="month" id="" required>
					...
					</select> <select name="year" id="" required>
				...
				<tr>
					...
					<td><input type="radio" name="gender" id="gender-male"
						value="Male" required> <label for="gender-male">Male</label>
						<input type="radio" name="gender" id="gender-female"
						value="Female"> <label for="gender-female">Female</label></td>
				</tr>
				<tr>
